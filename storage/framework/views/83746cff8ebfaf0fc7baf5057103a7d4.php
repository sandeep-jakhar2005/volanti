<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('admin::app.promotions.cart-rules.edit-title')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="cart-rule-template">
        <div>
            <form method="POST" action="<?php echo e(route('admin.cart_rules.update', $cartRule->id)); ?>" @submit.prevent="onSubmit">
                ...
                <div class="page-content">
                    <div class="form-container">
                        ...
                        <accordian title="<?php echo e(__('admin::app.promotions.cart-rules.rule-information')); ?>" :active="true">
                            <div slot="body">
                                <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    ...
                                    <input v-validate="'required'" class="control" id="name" name="name" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.name')); ?>&quot;" value="<?php echo e(old('name') ?: $cartRule->name); ?>"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <textarea class="control" id="description" name="description"><?php echo e(old('description') ?: $cartRule->description); ?></textarea>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="status" name="status" value="<?php echo e($cartRule->status); ?>" <?php echo e($cartRule->status ? 'checked' : ''); ?>>
                                ...
                                <div class="control-group" :class="[errors.has('customer_groups[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="customer_groups" name="customer_groups[]" v-validate="'required'" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.customer-groups')); ?>&quot;" multiple="multiple">
                                        ...
                                        <?php $__currentLoopData = app('Webkul\Customer\Repositories\CustomerGroupRepository')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customerGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customerGroup->id); ?>" <?php echo e(in_array($customerGroup->id, $selectedOptionIds) ? 'selected' : ''); ?>>
                                ...
                                <div v-if="parseInt(coupon_type)">
                                    ...
                                    <div v-if="! parseInt(use_auto_generation)">
                                        <div class="control-group" :class="[errors.has('coupon_code') ? 'has-error' : '']">
                                            ...
                                            <input v-validate="'required'" class="control" id="coupon_code" name="coupon_code" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.coupon-code')); ?>&quot;" value="<?php echo e(old('coupon_code') ?: $cartRule->coupon_code); ?>"/>
                                    ...
                                    <div class="control-group" :class="[errors.has('uses_per_coupon') ? 'has-error' : '']">
                                        ...
                                        <input  v-validate="'numeric'" class="control" id="uses_per_coupon" name="uses_per_coupon" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.uses-per-coupon')); ?>&quot;" value="<?php echo e(old('uses_per_coupon') ?: $cartRule->uses_per_coupon); ?>"/>
                                ...
                                <div class="control-group" :class="[errors.has('usage_per_customer') ? 'has-error' : '']">
                                    ...
                                    <input v-validate="'numeric'" class="control" id="usage_per_customer" name="usage_per_customer" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.uses-per-customer')); ?>&quot;"  value="<?php echo e(old('usage_per_customer') ?: $cartRule->usage_per_customer); ?>"/>
                                ...
                                <div class="control-group date">
                                    ...
                                    <datetime>
                                        <input type="text" name="starts_from" class="control" value="<?php echo e(old('starts_from') ?: $cartRule->starts_from); ?>"/>
                                    </datetime>
                                </div>
                                ...
                                <div class="control-group date" :class="[errors.has('ends_till') ? 'has-error' : '']">
                                    ...
                                    <datetime>
                                        <input type="text" v-validate="" class="control" name="ends_till" value="<?php echo e(old('ends_till') ?: $cartRule->ends_till); ?>"/>
                                    </datetime>
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="text" class="control" id="sort_order" name="sort_order" value="<?php echo e($cartRule->sort_order); ?>" <?php echo e($cartRule->sort_order ? 'checked' : ''); ?>/>
                                </div>
                            </div>
                        </accordian>
                            ...
                            <div slot="body">
                                <div class="control-group" :class="[errors.has('action_type') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="action_type" name="action_type" v-validate="'required'" v-model="action_type" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.action-type')); ?>&quot;">
                                        <option value="by_percent" <?php echo e($selectedOption == 'by_percent' ? 'selected' : ''); ?>>
                                            <?php echo e(__('admin::app.promotions.cart-rules.percentage-product-price')); ?>

                                        </option>

                                        <option value="by_fixed" <?php echo e($selectedOption == 'by_fixed' ? 'selected' : ''); ?>>
                                            <?php echo e(__('admin::app.promotions.cart-rules.fixed-amount')); ?>

                                        </option>

                                        <option value="cart_fixed" <?php echo e($selectedOption == 'cart_fixed' ? 'selected' : ''); ?>>
                                            <?php echo e(__('admin::app.promotions.cart-rules.fixed-amount-whole-cart')); ?>

                                        </option>

                                        <option value="buy_x_get_y" <?php echo e($selectedOption == 'buy_x_get_y' ? 'selected' : ''); ?>>
                                ...
                                <div class="control-group" :class="[errors.has('discount_amount') ? 'has-error' : '']">
                                    ...
                                    <input v-validate="'required'" class="control" id="discount_amount" name="discount_amount" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.discount-amount')); ?>&quot;" value="<?php echo e(old('discount_amount') ?: $cartRule->discount_amount); ?>"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <input class="control" id="discount_quantity" name="discount_quantity" value="<?php echo e(old('discount_quantity') ?: $cartRule->discount_quantity); ?>"/>
                                </div>

                                <div class="control-group">
                                    <label for="discount_step"><?php echo e(__('admin::app.promotions.cart-rules.discount-step')); ?></label>

                                    <input class="control" id="discount_step" name="discount_step" value="<?php echo e(old('discount_step') ?: $cartRule->discount_step); ?>"/>
                                </div>
                        ...
                        <accordian title="<?php echo e(__('admin::app.promotions.cart-rules.coupon-codes')); ?>" :active="false" v-if="parseInt(use_auto_generation) && parseInt(coupon_type)">
                            <div slot="body">
            ...
            <div class="value">
                <div v-if="matchedAttribute">
                    ...
                    <div v-if="matchedAttribute.key == 'product|children::category_ids' || matchedAttribute.key == 'product|category_ids' || matchedAttribute.key == 'product|parent::category_ids'">
                        <tree-view value-field="id" id-field="id" :name-field="'conditions[' + index + '][value]'" input-type="checkbox" :items='matchedAttribute.options' :value='condition.value' :behavior="'no'" fallback-locale="<?php echo e(config('app.fallback_locale')); ?>"></tree-view>
                    </div>
        ...
        <div class="">
            <form method="POST" data-vv-scope="create-coupon-form" @submit.prevent="generateCoupons('create-coupon-form')">
                <div class="control-group" :class="[errors.has('create-coupon-form.coupon_qty') ? 'has-error' : '']">
                    <label for="coupon_qty" class="required"><?php echo e(__('admin::app.promotions.cart-rules.coupon-qty')); ?></label>

                    <input v-validate="'required|min_value:1'" class="control" id="coupon_qty" name="coupon_qty" v-model="coupon_format.coupon_qty" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.coupon-qty')); ?>&quot;"/>
                ...
                <div class="control-group" :class="[errors.has('create-coupon-form.code_length') ? 'has-error' : '']">
                    <label for="code_length" class="required"><?php echo e(__('admin::app.promotions.cart-rules.code-length')); ?></label>

                    <input v-validate="'required|min_value:10'" class="control" id="code_length" name="code_length" v-model="coupon_format.code_length" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.code-length')); ?>&quot;"/>
                ...
                <div class="control-group" :class="[errors.has('create-coupon-form.code_format') ? 'has-error' : '']">
                    <label for="code_format" class="required"><?php echo e(__('admin::app.promotions.cart-rules.code-format')); ?></label>

                    <select class="control" id="code_format" name="code_format" v-model="coupon_format.code_format" v-validate="'required'" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.cart-rules.code-format')); ?>&quot;">
                        <option value="alphanumeric"><?php echo e(__('admin::app.promotions.cart-rules.alphanumeric')); ?></option>
                        <option value="alphabetical"><?php echo e(__('admin::app.promotions.cart-rules.alphabetical')); ?></option>
                        <option value="numeric"><?php echo e(__('admin::app.promotions.cart-rules.numeric')); ?></option>
                    </select>
                ...
                <div class="control-group">
                    <label for="code_prefix"><?php echo e(__('admin::app.promotions.cart-rules.code-prefix')); ?></label>
                    <input class="control" id="code_prefix" name="code_prefix" v-model="coupon_format.code_prefix"/>
                </div>

                <div class="control-group">
                    <label for="code_suffix"><?php echo e(__('admin::app.promotions.cart-rules.code-suffix')); ?></label>
                    <input class="control" id="code_suffix" name="code_suffix" v-model="coupon_format.code_suffix"/>
                </div>

                <div class="button-group">
                    <button class="btn btn-xl btn-primary"><?php echo e(__('admin::app.promotions.cart-rules.generate')); ?></button>
                </div>
            </form>
            ...
            <datagrid-plus src="<?php echo e(route('admin.cart_rules.coupons.index', $cartRule->id)); ?>"></datagrid-plus>
        </div>
    </script>

    <?php $__env->startPush('scripts'); ?>
        <?php echo $__env->make('admin::export.export', ['gridName' => app('Webkul\Admin\DataGrids\CartRuleCouponDataGrid')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopPush(); ?>
    ...
    <script>
        Vue.component('cart-rule', {
            ...
            data: function() {
                return {
                    coupon_type: <?php echo e(old('coupon_type') ?: $cartRule->coupon_type); ?>,

                    use_auto_generation: <?php echo e(old('use_auto_generation') ?: $cartRule->use_auto_generation); ?>,

                    condition_type: <?php echo e(old('condition_type') ?: $cartRule->condition_type); ?>,

                    conditions: <?php echo json_encode($cartRule->conditions ?: [], 15, 512) ?>,

                    action_type: "<?php echo e(old('action_type') ?: $cartRule->action_type); ?>"
                }
            },
            ...
            methods: {
                generateCoupons: function(formScope) {
                    ...
                    this.$validator.validateAll(formScope).then(function (result) {
                        if (result) {
                            self.$http.post("<?php echo e(route('admin.cart_rules.coupons.store', $cartRule->id)); ?>", self.coupon_format)
...
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/marketing/promotions/cart-rules/edit.blade.php ENDPATH**/ ?>