...
<div class="table">
    ...
    <?php if(! empty($results['paginated'])): ?>
                ...
                <div class="filter-advance">
                    ...
                    <div class="records-count-container">
                        <span class="datagrid-count">
                            <?php echo e($results['records']->total()); ?>   <?php echo e(__('admin::app.admin.system.records-found')); ?>
            ...
            Vue.component('datagrid-filters', {
                ...
                methods: {
                                    ...
                                    for (let j = 0; j < this.filters.length; j++) {
                                        if (this.filters[j].column === column) {
                                            if (this.filters[j].cond === condition && this.filters[j].val === response) {
                                                ...
                                                alert('<?php echo e(__('ui::app.datagrid.filter-exists')); ?>');
                    ...
                    doAction: function (e, message, type) {
                        ...
                        message = message || '<?php echo e(__('ui::app.datagrid.mass-action.delete')); ?>';
...
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Ui/src/Providers/../Resources/views/datagrid/table.blade.php ENDPATH**/ ?>