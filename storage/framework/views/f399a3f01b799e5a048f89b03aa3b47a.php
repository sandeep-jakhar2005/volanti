<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('admin::app.promotions.catalog-rules.edit-title')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="catalog-rule-template">
        <div>
            <form method="POST" action="<?php echo e(route('admin.catalog_rules.update', $catalogRule->id)); ?>" @submit.prevent="onSubmit">
                        ...
                        <accordian title="<?php echo e(__('admin::app.promotions.catalog-rules.rule-information')); ?>" :active="true">
                            <div slot="body">
                                <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    ...
                                    <input v-validate="'required'" class="control" id="name" name="name" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.catalog-rules.name')); ?>&quot;" value="<?php echo e(old('name') ?: $catalogRule->name); ?>"/>
                                    <span class="control-error" v-if="errors.has('name')">{{ errors.first('name') }}</span>
                                </div>

                                <div class="control-group">
                                    <label for="description"><?php echo e(__('admin::app.promotions.catalog-rules.description')); ?></label>
                                    <textarea class="control" id="description" name="description"><?php echo e(old('description') ?: $catalogRule->description); ?></textarea>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="status" name="status" value="<?php echo e($catalogRule->status); ?>" <?php echo e($catalogRule->status ? 'checked' : ''); ?>>
                                ...
                                <div class="control-group date">
                                    ...
                                    <date>
                                        <input type="text" name="starts_from" class="control" value="<?php echo e(old('starts_from') ?: $catalogRule->starts_from); ?>"/>
                                    </date>
                                </div>
                                ...
                                <div class="control-group date" :class="[errors.has('ends_till') ? 'has-error' : '']">
                                    ...
                                    <date>
                                        <input type="text" v-validate="" class="control" id="ends_till" name="ends_till" value="<?php echo e(old('ends_till') ?: $catalogRule->ends_till); ?>"/>
                                    </date>
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="text" class="control" id="sort_order" name="sort_order" value="<?php echo e($catalogRule->sort_order); ?>" <?php echo e($catalogRule->status ? 'checked' : ''); ?>/>
                                </div>
                            </div>
                        </accordian>
                        ...
                        <accordian title="<?php echo e(__('admin::app.promotions.catalog-rules.actions')); ?>" :active="false">
                            <div slot="body">
                                ...
                                <div class="control-group" :class="[errors.has('discount_amount') ? 'has-error' : '']">
                                    ...
                                    <input v-validate="'required'" class="control" id="discount_amount" name="discount_amount" data-vv-as="&quot;<?php echo e(__('admin::app.promotions.catalog-rules.discount-amount')); ?>&quot;" value="<?php echo e(old('discount_amount') ?: $catalogRule->discount_amount); ?>"/>
    ...
    <script>
        Vue.component('catalog-rule', {
            ...
            data: function() {
                return {
                    condition_type: <?php echo e(old('condition_type') ?: $catalogRule->condition_type); ?>,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/marketing/promotions/catalog-rules/edit.blade.php ENDPATH**/ ?>