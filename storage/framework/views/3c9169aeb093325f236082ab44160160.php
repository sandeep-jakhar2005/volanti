...
<div class="container my-5 checkout_order_invoice p-4" style="max-width: 100% !important">
    <div class="head mb-4">
        <p>Please fill your email and fbo tail number to pay your order: <span><?php echo e($order_detail->orderid); ?></span></p>
    </div>
    
    <form action="<?php echo e(route('order-invoice-view-detail',['orderid'=> $order_detail->orderid,'customerid'=> $order_detail->customerid])); ?>" method="POST" @submit.prevent="onSubmit">
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/resources/themes/volantijetcatering/views/sales/invoice-form.blade.php ENDPATH**/ ?>