        ...
        methods: {
            ...
            search: function (key) {
                ...
                if (this.search_term[key].length >= 1) {
                    this.$http.get ("<?php echo e(route('admin.catalog.products.product_link_search')); ?>", {params: {query: this.search_term[key]}})
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/product-links.blade.php ENDPATH**/ ?>