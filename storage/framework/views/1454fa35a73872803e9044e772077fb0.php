...
<accordian title="<?php echo e(__('admin::app.catalog.products.images')); ?>" :active="false">
    <div slot="body">
        ...
        <div class="control-group <?php echo e($errors->has('images.files.*') ? 'has-error' : ''); ?>">
            ...
            <span class="control-info mt-10"><?php echo e(__('admin::app.catalog.products.image-drop')); ?></span>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/images.blade.php ENDPATH**/ ?>