...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <form
            ...
            action="<?php echo e(route('admin.cateringpackage.update',$airport->id)); ?>">
            
            <div class="page-header">

                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '<?php echo e(route('admin.cateringpackage.index')); ?>'"></i>

                        <?php echo e(__('admin::app.settings.cateringpackages.edit-title')); ?>
                ...
                <div class="form-container">
                    ...
                    <?php echo view_render_event('bagisto.admin.settings.slider.create.before'); ?>
                     ...
                     <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']"> 
                        ...
                        <input type="text" class="control" id="sort_order" name="name" v-validate="'required'" value="<?php echo e($airport->name); ?>"/>
                        <span class="control-error" v-if="errors.has('name')">{{ errors.first('name') }}</span>

                    </div>

                      <input type="hidden" value="<?php echo e($airport->state); ?>" id="hidden_state">
                    ...
                    <div class="control-group" :class="[errors.has('address') ? 'has-error' : '']">
                        ...
                        <textarea v-validate="'required'" id="" class="control" id="address" name="address" rows="5"><?php echo e($airport->address); ?></textarea>
                     ...
                     <div class="control-group" :class="[errors.has('zipcode') ? 'has-error' : '']"> 
                        ...
                        <input v-validate="'required'" type="text" class="control" id="zipcode" name="zipcode" value="<?php echo e($airport->zipcode); ?>"/>
                    ...
                    <div class="control-group multi-select" :class="[errors.has('country') ? 'has-error' : '']">
                        ...
                        <select v-validate="'required'" class="control" id="country" name="country"  value="" v-validate="'required'" >
                             <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>" <?php echo e($country->id == $airport->country ? 'selected' : ''); ?>>
                     ...
                     <div class="control-group multi-select" :class="[errors.has('state') ? 'has-error' : '']">
                        ...
                        <select class="control" id="state" name="state" data-vv-as="&quot;<?php echo e(__('admin::app.datagrid.locale')); ?>&quot;" value="" v-validate="'required'" >
                    ...
                    <div class="control-group" :class="[errors.has('latitude') ? 'has-error' : '']"> 
                        ...
                        <input type="text" class="control" id="sort_order" name="latitude" value="<?php echo e($airport->latitude); ?>"  v-validate="'required'"/>
                    ...
                    <div class="control-group" :class="[errors.has('longitude') ? 'has-error' : '']"> 
                        ...
                        <input type="text" class="control" id="sort_order" name="longitude" value="<?php echo e($airport->longitude); ?>"  v-validate="'required'" />
                    ...
                    <div class="control-group" :class="[errors.has('display_order') ? 'has-error' : '']"> 
                        ...
                        <input type="text" class="control" id="sort_order" name="display_order" value="<?php echo e($airport->display_order); ?>" v-validate="'required'" />
                    ...
                    <div class="control-group" :class="[errors.has('active') ? 'has-error' : '']">
                        <div class="active_airport_button">
                            ...
                            <input type="checkbox" class="control active_airport_checkbox" id="active" name="active" 
                                 <?php echo e($airport->active == 1 ? 'checked' : ''); ?> />
                        </div>
...
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/ACME/CateringPackage/src/Resources/views/admin/edit.blade.php ENDPATH**/ ?>