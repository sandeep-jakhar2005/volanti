                    ...
                    <div class="col-12">
                        <div class="col-6">
                            <div class="merchant-details">
                                ...
                                <div class="row">
                                    <span class="label"><?php echo e(__('admin::app.sales.invoices.date')); ?>: </span>
                                    <span class="value"><?php echo e(core()->formatDate($invoice->created_at, 'm-d-Y')); ?></span>
                                </div>
                        ...
                        <div class="col-6" style="padding-left: 80px">
                            ...
                            <?php if($invoice->hasPaymentTerm()): ?>
                                <div class="row">
                                    <span class="label"><?php echo e(__('admin::app.customer.account.order.view.payment-terms')); ?> -</span>
            ...
            <div class="invoice-summary">
                <div class="table address">
                    <table>
                        <thead>
                            <tr>
                                <th class="table-header align-left" style="width: 50%;"><?php echo e(ucwords(trans('admin::app.sales.invoices.bill-to'))); ?></th>
                                <?php if($invoice->order->shipping_address): ?>
                                    <th class="table-header align-left"><?php echo e(ucwords(trans('admin::app.sales.invoices.ship-to'))); ?></th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                ...
                <div class="table payment-shipment">
                    <table>
                        <thead>
                            <tr>
                                <th class="table-header align-left" style="width: 50%;"><?php echo e(__('admin::app.sales.orders.payment-method')); ?></th>

                                <?php if($invoice->order->shipping_address): ?>
                                    <th class="table-header align-left"><?php echo e(__('admin::app.sales.orders.shipping-method')); ?></th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                ...
                <div class="table items">
                    <table>
                        <thead>
                            <tr>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.SKU')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.product-name')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.price')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.qty')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.subtotal')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.tax-amount')); ?></th>
                                <th class="text-center table-header"><?php echo e(__('admin::app.sales.orders.grand-total')); ?></th>
                            </tr>
                        </thead>
...
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/sales/invoices/pdf.blade.php ENDPATH**/ ?>