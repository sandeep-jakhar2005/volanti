<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('admin::app.error.403.page-title')); ?>
    ...
    <div class="error-container" style="width: 100%; display: flex; justify-content: center;">
        ...
        <div class="wrapper" style="display: flex; height: 60vh; width: 100%;
            ...
            <div class="error-box"  style="width: 50%">
                ...
                <div class="error-title" style="font-size: 100px;color: #5E5E5E">  <?php echo e(__('admin::app.error.403.name')); ?>  </div>

                <div class="error-messgae" style="font-size: 24px;color: #5E5E5E; margin-top: 40px">
                    <?php echo e(__('admin::app.error.403.title')); ?>

                </div>

                <div class="error-description" style="margin-top: 20px;margin-bottom: 20px;color: #242424">
                    <?php echo e(__('admin::app.error.403.message')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/errors/403.blade.php ENDPATH**/ ?>