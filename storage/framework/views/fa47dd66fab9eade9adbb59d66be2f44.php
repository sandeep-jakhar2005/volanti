...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <form method="POST" action="<?php echo e(route('admin.inventory_sources.store')); ?>" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <?php echo view_render_event('bagisto.admin.settings.inventory.create.before'); ?>
                    ...
                    <accordian title="<?php echo e(__('admin::app.settings.inventory_sources.general')); ?>" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('code') ? 'has-error' : '']">
                                ...
                                <input v-validate="'required'" class="control" id="code" name="code" value="<?php echo e(old('code')); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.code')); ?>&quot;" v-code/>
                                <span class="control-error" v-if="errors.has('code')">{{ errors.first('code') }}</span>
                            </div>

                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                <label for="name" class="required"><?php echo e(__('admin::app.settings.inventory_sources.name')); ?></label>
                                <input v-validate="'required'" class="control" id="name" name="name" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.name')); ?>&quot;" value="<?php echo e(old('name')); ?>"/>
                            ...
                            <div class="control-group" :class="[errors.has('latitude') ? 'has-error' : '']">
                                ...
                                <input class="control" id="latitude" name="latitude" value="<?php echo e(old('latitude')); ?>" v-validate="'between:-90,90'"/>
                            ...
                            <div class="control-group" :class="[errors.has('longitude') ? 'has-error' : '']">
                                ...
                                <input class="control" id="longitude" name="longitude" value="<?php echo e(old('longitude')); ?>" v-validate="'between:-180,180'"/>
                            ...
                            <div class="control-group" :class="[errors.has('priority') ? 'has-error' : '']">
                                ...
                                <input class="control" id="priority" name="priority" value="<?php echo e(old('priority')); ?>" v-validate="'numeric'"/>
                    ...
                    <accordian title="<?php echo e(__('admin::app.settings.inventory_sources.contact-info')); ?>" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('contact_name') ? 'has-error' : '']">
                                ...
                                <input class="control" v-validate="'required'" class="required" id="contact_name" name="contact_name" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.contact_name')); ?>&quot;" value="<?php echo e(old('contact_name')); ?>"/>
                            ...
                            <div class="control-group" :class="[errors.has('contact_email') ? 'has-error' : '']">
                                ...
                                <input class="control" v-validate="'required|email'" class="required" id="contact_email" name="contact_email" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.contact_email')); ?>&quot;" value="<?php echo e(old('contact_email')); ?>"/>
                            ...
                            <div class="control-group" :class="[errors.has('contact_number') ? 'has-error' : '']">
                                ...
                                <input class="control" v-validate="'required'" class="required" id="contact_number" name="contact_number" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.contact_number')); ?>&quot;" value="<?php echo e(old('contact_number')); ?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <input class="control" class="required" id="country" name="contact_fax" value="<?php echo e(old('contact_fax')); ?>"/>
                            </div>
                    ...
                    <accordian title="<?php echo e(__('admin::app.settings.inventory_sources.address')); ?>" :active="true">
                        <div slot="body">
                            ...
                            <?php echo $__env->make('admin::customers.country-state', ['countryCode' => old('country'), 'stateCode' => old('state')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                            <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                                <label for="city" class="required"><?php echo e(__('admin::app.settings.inventory_sources.city')); ?></label>
                                <input v-validate="'required'" class="control" id="city" name="city" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.city')); ?>&quot;" value="<?php echo e(old('city')); ?>"/>
                            ...
                            <div class="control-group" :class="[errors.has('street') ? 'has-error' : '']">
                                ...
                                <input v-validate="'required'" class="control" id="street" name="street" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.street')); ?>&quot;" value="<?php echo e(old('street')); ?>"/>
                            ...
                            <div class="control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                                ...
                                <input v-validate="'required'" class="control" id="postcode" name="postcode" data-vv-as="&quot;<?php echo e(__('admin::app.settings.inventory_sources.postcode')); ?>&quot;" value="<?php echo e(old('postcode')); ?>"/>
                    ...
                    <?php echo view_render_event('bagisto.admin.settings.inventory.create.after'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/settings/inventory_sources/create.blade.php ENDPATH**/ ?>