...
<?php $__env->startSection('page-detail-wrapper'); ?>
    ...
    <?php echo view_render_event('bagisto.shop.customers.account.address.create.before'); ?>
        ...
        <form method="post" action="<?php echo e(route('shop.customer.addresses.store')); ?>" @submit.prevent="onSubmit">
            <div class="account-table-content mb-2">
                ...
                <div class="control-group" :class="[errors.has('company_name') ? 'has-error' : '']">
                    ...
                    <input
                        ...
                        data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.address.create.company_name')); ?>&quot;">
                ...
                <?php echo view_render_event('bagisto.shop.customers.account.address.create_form_controls.company_name.after'); ?>


                <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
                    <label for="first_name" class="mandatory"><?php echo e(__('shop::app.customer.account.address.create.first_name')); ?></label>

                    <input
                        class="control"
                        type="text"
                        name="first_name"
                        value="<?php echo e(old('first_name') ?? $currentCustomer->first_name); ?>"
                        v-validate="'required'"
                ...
                <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
                    <label for="last_name" class="mandatory"><?php echo e(__('shop::app.customer.account.address.create.last_name')); ?></label>

                    <input
                        class="control"
                        type="text"
                        name="last_name"
                        value="<?php echo e(old('last_name') ?? $currentCustomer->last_name); ?>"
                        v-validate="'required'"
                ...
                <?php echo view_render_event('bagisto.shop.customers.account.address.create_form_controls.vat_id.after'); ?>
                ...
                <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                    <label for="address_0" class="mandatory"><?php echo e(__('shop::app.customer.account.address.create.street-address')); ?></label>
                    ...
                    <span
                        class="control-error"
                        v-text="'<?php echo e($errors->first('address1.*')); ?>'">
                    </span>
                </div>
                ...
                <?php echo view_render_event('bagisto.shop.customers.account.address.create_form_controls.street-address.after'); ?>


                <?php echo $__env->make('shop::customers.account.address.country-state', ['countryCode' => old('country'), 'stateCode' => old('state')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <?php echo view_render_event('bagisto.shop.customers.account.address.create_form_controls.country-state.after'); ?>


                <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                    <label for="city" class="mandatory"><?php echo e(__('shop::app.customer.account.address.create.city')); ?></label>
                ...
                <?php echo view_render_event('bagisto.shop.customers.account.address.create_form_controls.city.after'); ?>


                <div class="control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                    <label for="postcode" class="<?php echo e(core()->isPostCodeRequired() ? 'mandatory' : ''); ?>"><?php echo e(__('shop::app.customer.account.address.create.postcode')); ?></label>
                ...
                <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                    <label for="phone" class="mandatory"><?php echo e(__('shop::app.customer.account.address.create.phone')); ?></label>
                ...
                <div class="control-group d-flex">
                    <input
                        ...
                        <?php echo e(old('default_address') ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/customers/account/address/create.blade.php ENDPATH**/ ?>