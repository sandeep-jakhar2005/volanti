                ...
                methods: {
                    ...
                    isCustomerExist: function() {
                        ...
                        .then(isValid => {
                            ...
                            this.$http.post("<?php echo e(route('shop.customer.checkout.exist')); ?>", {email: this.address.billing.email})
                            .then(response => {
                    ...
                    saveShipping: async function () {
                        ...
                        this.$http.post("<?php echo e(route('shop.checkout.save_shipping')); ?>", {'shipping_method': this.selected_shipping_method})
                            .then(response => {
                                this.$root.hideLoader();
                                this.disable_button = false;
                                this.showPaymentSection = true;
                    ...
                    savePayment: async function () {
                        ...
                        if (this.isCheckPayment) {
                            ...
                            this.$http.post("<?php echo e(route('shop.checkout.save_payment')); ?>", {'payment': this.selected_payment_method})
                            .then(response => {
                    ...
                    placeOrder: async function () {
                        if (this.isPlaceOrderEnabled) {
                            ...
                            this.$http.post("<?php echo e(route('shop.checkout.save_order')); ?>", {'_token': "<?php echo e(csrf_token()); ?>"})
                            .then(response => {
                                if (response.data.success) {
                            ...
                            .catch(error => {
                                ...
                                window.showAlert(`alert-danger`, this.__('shop.general.alert.danger'), error.response.data.message ? error.response.data.message : "<?php echo e(__('shop::app.common.error')); ?>");
                            })
                        } else {
                            this.disable_button = true;
                        }
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/checkout/onepage.blade.php ENDPATH**/ ?>