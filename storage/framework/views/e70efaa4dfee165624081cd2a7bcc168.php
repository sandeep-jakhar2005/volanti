            ...
            <div class="col-main">
                <ul class="checkout-steps">
                    ...
                    <li :class="[current_step == 4 ? 'active' : '']">
                        ...
                        <span><?php echo e(__('shop::app.checkout.onepage.review')); ?></span>
                    </li>
                </ul>
        ...
        Vue.component('checkout', {
            ...
            methods: {
                ...
                isCustomerExist: function() {
                    ...
                    this.$validator.validate('email', this.address.billing.email)
                        .then(function(isValid) {
                            ...
                            self.$http.post("<?php echo e(route('shop.customer.checkout.exist')); ?>", {email: self.address.billing.email})
                ...
                loginCustomer: function() {
                    ...
                    self.$http.post("<?php echo e(route('shop.customer.checkout.login')); ?>", {
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/checkout/onepage.blade.php ENDPATH**/ ?>