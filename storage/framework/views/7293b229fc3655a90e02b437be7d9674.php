...
<body>
    ...
    <body style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5;">
        ...
        <?php if($order->customer_first_name != ''): ?>
            <p style="color: #666;">Dear <?php echo e($order->customer_first_name . ' ' . $order->customer_last_name); ?>,</p>
        <?php else: ?>
            <p style="color: #666;">Dear <?php echo e($order->fbo_full_name); ?>,</p>
        <?php endif; ?>
...
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/ACME/paymentProfile/src/Providers/../Resources/views/admin/sales/shipments/mail/order_deliver.blade.php ENDPATH**/ ?>