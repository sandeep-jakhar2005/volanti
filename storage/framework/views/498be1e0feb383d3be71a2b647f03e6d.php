<?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.bundle.before', ['product' => $product]); ?>


<accordian title="<?php echo e(__('admin::app.catalog.products.bundle-items')); ?>" :active="true">
    <div slot="body">

        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.bundle.controls.before', ['product' => $product]); ?>


        <bundle-option-list></bundle-option-list>

        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.bundle.controls.after', ['product' => $product]); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="bundle-option-list-template">
        <div class="">
            ...
            <button type="button" class="btn btn-md btn-primary bundle-option-button" @click="addOption">
                <?php echo e(__('admin::app.catalog.products.add-option-btn-title')); ?>
    ...
    <script type="text/x-template" id="bundle-option-item-template">
        <accordian :active="true">
            <div slot="header">
                ...
                <h1 v-else><?php echo e(__('admin::app.catalog.products.new-option')); ?></h1>
                <i class="icon trash-icon" @click="removeOption()"></i>
            </div>

            <div slot="body">
                <div class="control-group" :class="[errors.has(titleInputName + '[label]') ? 'has-error' : '']">
                    <label class="required"><?php echo e(__('admin::app.catalog.products.option-title')); ?></label>

                    <input type="text" v-validate="'required'" :name="titleInputName + '[label]'" v-model="option.label" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.option-title')); ?>&quot;"/>
                ...
                <div class="control-group" :class="[errors.has(inputName + '[type]') ? 'has-error' : '']">
                    <label class="required"><?php echo e(__('admin::app.catalog.products.input-type')); ?></label>

                    <select v-validate="'required'" :name="inputName + '[type]'" v-model="option.type" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.input-type')); ?>&quot;">
                        <option value="select"><?php echo e(__('admin::app.catalog.products.select')); ?></option>
                        <option value="radio"><?php echo e(__('admin::app.catalog.products.radio')); ?></option>
                        <option value="checkbox"><?php echo e(__('admin::app.catalog.products.checkbox')); ?></option>
                        <option value="multiselect"><?php echo e(__('admin::app.catalog.products.multiselect')); ?></option>
                    </select>
                ...
                <div class="control-group" :class="[errors.has(inputName + '[is_required]') ? 'has-error' : '']">
                    <label class="required"><?php echo e(__('admin::app.catalog.products.is-required')); ?></label>

                    <select v-validate="'required'" :name="inputName + '[is_required]'" v-model="option.is_required" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.is-required')); ?>&quot;">
                        <option value="1"><?php echo e(__('admin::app.catalog.products.yes')); ?></option>
                        <option value="0"><?php echo e(__('admin::app.catalog.products.no')); ?></option>
                    </select>
                ...
                <div class="control-group" :class="[errors.has(inputName + '[sort_order]') ? 'has-error' : '']">
                    <label class="required"><?php echo e(__('admin::app.catalog.products.sort-order')); ?></label>

                    <input type="text" v-validate="'required|numeric|min_value:0'" :name="inputName + '[sort_order]'" v-model="option.sort_order" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sort-order')); ?>&quot;"/>
    ...
    <script type="text/x-template" id="bundle-product-list-template">
        <div>
            <div class="control-group">
                <label><?php echo e(__('admin::app.catalog.products.search-products')); ?></label>

                <input type="text" class="control" placeholder="<?php echo e(__('admin::app.catalog.products.product-search-hint')); ?>" v-model.lazy="search_term" v-debounce="500" autocomplete="off">
            ...
            <div class="table" style="margin-top: 20px; overflow-x: unset;">
                <table>
                    <thead>
                        <tr>
                            <th class="name"><?php echo e(__('admin::app.catalog.products.is-default')); ?></th>
                            <th class="name"><?php echo e(__('admin::app.catalog.products.name')); ?></th>
                            <th class="sku"><?php echo e(__('admin::app.catalog.products.sku')); ?></th>
                            <th class="qty"><?php echo e(__('admin::app.catalog.products.qty')); ?></th>
                            <th class="sort-order"><?php echo e(__('admin::app.catalog.products.sort-order')); ?></th>
                            <th class="actions"></th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="bundle-product-item-with-options">
                        ...
                        <tr v-if="! bundle_option_products.length">
                            <td colspan="10">
                                <p class="no-product-item-found"><?php echo e(__('admin::app.catalog.products.no-product-added')); ?> </p>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <tr>
            ...
            <td>
                <div class="control-group" :class="[errors.has(inputName + '[qty]') ? 'has-error' : '']">
                    <input type="number" v-validate="`required|min_value:0|max_value:${available_qty}`" :name="[inputName + '[qty]']" v-model="product.qty" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.qty')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(inputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|min_value:1'" :name="[inputName + '[sort_order]']" v-model="product.sort_order" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sort-order')); ?>&quot;"/>
                    <span class="control-error" v-if="errors.has(inputName + '[sort_order]')">{{ errors.first(inputName + '[sort_order]') }}</span>
                </div>
            </td>
    ...
    <script>
        Vue.component('bundle-option-list', {
            ...
            data: function() {
                return {
                    options: <?php echo json_encode($product->bundle_options()->with(['product', 'bundle_option_products', 'bundle_option_products.product.inventory_indices'])->get()) ?>
                }
            },
        ...
        Vue.component('bundle-option-item', {
            ...
            computed: {
                titleInputName: function () {
                    if (this.option.id)
                        return "bundle_options[" + this.option.id + "]" + '[<?php echo e($locale); ?>]';

                    return "bundle_options[option_" + this.index + "]" + '[<?php echo e($locale); ?>]';
                },
        ...
        Vue.component('bundle-product-list', {
            ...
            methods: {
                ...
                search: function (key) {
                    ...
                    this.$http.get ("<?php echo e(route('admin.catalog.products.search_simple_product')); ?>", {params: {query: this.search_term}})
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/catalog/products/accordians/bundle-items.blade.php ENDPATH**/ ?>