    ...
    <form
        ...
        <div class="account-table-content">
            ...
            <div :class="`row ${errors.has('first_name') ? 'has-error' : ''}`">
                ...
                <div class="col-12">
                    <input value="<?php echo e($customer->first_name); ?>" name="first_name" type="text" v-validate="'required'" data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.profile.fname')); ?>&quot;" />
            ...
            <div :class="`row ${errors.has('last_name') ? 'has-error' : ''}`">
                ...
                <div class="col-12">
                    <input value="<?php echo e($customer->last_name); ?>" name="last_name" type="text" v-validate="'required'" data-vv-as="&quot;<?php echo e(__('shop::app.customer.account.profile.lname')); ?>&quot;" />
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <input value="<?php echo e(old('phone') ?? $customer->phone); ?>" name="phone" type="text"/>
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/customers/account/profile/edit.blade.php ENDPATH**/ ?>