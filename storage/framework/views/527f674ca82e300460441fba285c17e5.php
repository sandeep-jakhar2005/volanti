<?php if($product->type == 'bundle'): ?>
            ...
            <div class="col-12 bundle-options-wrapper">
                ...
                <div class="bundle-summary">
                    ...
                    <div class="control-group mt10 mb20">
                        <label class="mb10"><?php echo e(__('shop::app.products.total-amount')); ?></label>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/products/view/bundle-options.blade.php ENDPATH**/ ?>