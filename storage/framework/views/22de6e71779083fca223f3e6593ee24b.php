            ...
            <div class="discount-control">
                <form class="coupon-form" method="post" @submit.prevent="applyCoupon">
                    <div class="control-group" :class="[errorMessage ? 'has-error' : '']">
                        <input type="text" class="control" v-model="couponCode" name="code" placeholder="<?php echo e(__('shop::app.checkout.onepage.enter-coupon-code')); ?>">

                        <div class="control-error">{{ errorMessage }}</div>
                    </div>

                    <button class="btn btn-lg btn-black" :disabled="disableButton"><?php echo e(__('shop::app.checkout.onepage.apply-coupon')); ?></button>
                </form>
            </div>
        ...
        Vue.component('coupon-component', {
            ...
            methods: {
                applyCoupon: function() {
                    ...
                    axios.post('<?php echo e(route('shop.checkout.cart.coupon.apply')); ?>', {code: self.couponCode})
...
<?php endif; ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/checkout/cart/coupon.blade.php ENDPATH**/ ?>