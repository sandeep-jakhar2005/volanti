        ...
        <div class="wrapper" style="display: flex; height: 60vh; width: 100%;
            ...
            <div class="error-box"  style="width: 50%">
                ...
                <div class="error-title" style="font-size: 100px;color: #5E5E5E">
                    <?php echo e(__('admin::app.error.401.name')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(auth()->guard('admin')->check() ? 'admin::layouts.master' : 'shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/errors/401.blade.php ENDPATH**/ ?>