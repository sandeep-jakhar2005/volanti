...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="whatsapp-share-link">
        <li class="bb-social-share__item bb-social--whatsapp" v-if="isMobile">
            <a :href="shareUrl" data-action="share/whatsapp/share" target="_blank">
                <?php echo $__env->make('social_share::icons.whatsapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </a>
        </li>
    </script>
    ...
    <script type="text/javascript">
        Vue.component('whatsapp-share', {
            ...
            data: function () {
                return {
                    shareUrl: '<?php echo e($whatsapp_url); ?>'
                }
            },
            computed: {
                isMobile: function () {
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/vendor/bagistobrasil/bagisto-product-social-share/src/Resources/views/links/whatsapp.blade.php ENDPATH**/ ?>