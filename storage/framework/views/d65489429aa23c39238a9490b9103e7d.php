<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('admin::app.marketing.templates.edit-title')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <form method="POST" action="<?php echo e(route('admin.email_templates.update', $template->id)); ?>" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <accordian title="<?php echo e(__('admin::app.marketing.templates.general')); ?>" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                ...
                                <input v-validate="'required'" class="control" id="name" name="name" value="<?php echo e(old('name') ?: $template->name); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.marketing.templates.name')); ?>&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                                ...
                                <select class="control" v-validate="'required'" id="status" name="status" data-vv-as="&quot;<?php echo e(__('admin::app.marketing.templates.display-mode')); ?>&quot;">
                                    <option value="active" <?php echo e($selectedOption == 'active' ? 'selected' : ''); ?>>
                                        <?php echo e(__('admin::app.marketing.templates.active')); ?>

                                    </option>
                                    <option value="inactive" <?php echo e($selectedOption == 'inactive' ? 'selected' : ''); ?>>
                                        <?php echo e(__('admin::app.marketing.templates.inactive')); ?>

                                    </option>
                                    <option value="draft" <?php echo e($selectedOption == 'draft' ? 'selected' : ''); ?>>
                            ...
                            <div class="control-group" :class="[errors.has('content') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'required'" class="control" id="content" name="content" data-vv-as="&quot;<?php echo e(__('admin::app.marketing.templates.content')); ?>&quot;"><?php echo e(old('content') ?: $template->content); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/marketing/email-marketing/templates/edit.blade.php ENDPATH**/ ?>