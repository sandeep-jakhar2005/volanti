...
<?php $__env->startSection('page-detail-wrapper'); ?>        
        <div class="account-head mb-0">
            ...
            <span class="account-heading">
                <?php echo e(__('mpauthorizenet::app.customer.account.savecard.index.title')); ?>

            </span>

            <span class="account-action">
                <a id="add-new-card" style="cursor: pointer;" class="theme-btn light unset pull-right">
                    <?php echo e(__('mpauthorizenet::app.customer.account.savecard.index.add')); ?>
                    ...
                    <table class="table">
                        ...
                        <tbody style="text-align:center;" class="list-order">
                            ...
                            <tr id="row<?php echo e($cardDetails->id); ?>">
                                ...
                                <td><span class="rango-delete fs20 delete" id="<?php echo e($cardDetails->id); ?>" style="cursor:pointer;"></span></td>
                            </tr>
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/MpAuthorizeNet/src/Resources/views/shop/volantijetcatering/customer/account/savecard/savecard.blade.php ENDPATH**/ ?>