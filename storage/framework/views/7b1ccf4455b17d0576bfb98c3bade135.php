<div class="booking-info-row">
    ...
    <span class="title">
        ...
        <?php echo e(__('bookingproduct::app.shop.products.slot-duration-in-minutes', ['minutes' => $bookingProduct->appointment_slot->duration])); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $bookingSlotHelper->getWeekSlotDurations($bookingProduct); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <?php if($day['slots'] && count($day['slots'])): ?>
...
<?php echo $__env->make('bookingproduct::shop.products.view.booking.slots', ['bookingProduct' => $bookingProduct], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/BookingProduct/src/Resources/views/shop/default/products/view/booking/appointment.blade.php ENDPATH**/ ?>