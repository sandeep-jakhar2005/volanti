...
<?php $__env->startSection('account-content'); ?>
    <div class="account-layout">
        ...
        <form id="customer-address-form" method="post" action="<?php echo e(route('shop.customer.addresses.store')); ?>" @submit.prevent="onSubmit">
            <div class="account-table-content">
                ...
                <div class="control-group <?php echo e($errors->has('address1.*') ? 'has-error' : ''); ?>">
                    <label for="address1" class="required"><?php echo e(__('shop::app.customer.account.address.create.street-address')); ?></label>
                ...
                <div class="control-group">
                    <span class="checkbox">
                        <input
                            ...
                            id="default_address"
                            type="checkbox"
                            name="default_address" <?php echo e(old('default_address') ? 'checked' : ''); ?> >
                ...
                <div class="button-group">
                    <input class="btn btn-primary btn-lg" type="submit" value="<?php echo e(__('shop::app.customer.account.address.create.submit')); ?>">
                </div>
            </div>
        </form>
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/customers/account/address/create.blade.php ENDPATH**/ ?>