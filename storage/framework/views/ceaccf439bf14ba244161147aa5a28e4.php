                ...
                <div class="form-container">
                    ...
                    <accordian title="<?php echo e(__('admin::app.users.roles.access-control')); ?>" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group">
                                <tree-view value-field="key" id-field="key" items='<?php echo json_encode($acl->items, 15, 512) ?>' fallback-locale="<?php echo e(config('app.fallback_locale')); ?>"></tree-view>
                            </div>
                        </div>
                    </accordian>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/users/roles/create.blade.php ENDPATH**/ ?>