...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <form method="POST" action="<?php echo e(route('admin.tax_rates.store')); ?>" @submit.prevent="onSubmit">
    ...
    <script type="text/x-template" id="tax-rate-form-template">
        <div>
            ...
            <div class="control-group">
                <label for="zip_code"><?php echo e(__('admin::app.configuration.tax-rates.is_zip')); ?></label>
            ...
            <div v-if="! is_zip" class="control-group" :class="[errors.has('zip_code') ? 'has-error' : '']" id="zip_code">
                ...
                <input class="control" id="zip_code" name="zip_code" data-vv-as="&quot;<?php echo e(__('admin::app.configuration.tax-rates.zip_code')); ?>&quot;" value="<?php echo e(old('zip_code')); ?>"/>
            ...
            <div class="control-group" :class="[errors.has('tax_rate') ? 'has-error' : '']">
                ...
                <input v-validate="'required|decimal|min_value:0.0001'" class="control" id="tax_rate" name="tax_rate" data-vv-as="&quot;<?php echo e(__('admin::app.configuration.tax-rates.tax_rate')); ?>&quot;" value="<?php echo e(old('tax_rate')); ?>"/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/tax/tax-rates/create.blade.php ENDPATH**/ ?>