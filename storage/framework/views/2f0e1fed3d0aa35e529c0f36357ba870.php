    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            ...
            <p style="text-align: center;padding: 20px 0;">
                <a href="<?php echo e(route('admin.reset_password.create', $token)); ?>" style="padding: 10px 20px;background: #0041FF;color: #ffffff;text-transform: uppercase;text-decoration: none; font-size: 16px">
...
<?php echo $__env->renderComponent(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/emails/admin/forget-password.blade.php ENDPATH**/ ?>