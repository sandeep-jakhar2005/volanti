...
<?php $__env->startSection('page-detail-wrapper'); ?>
    ...
    <form method="post" action="<?php echo e(route('shop.customer.addresses.update', $address->id)); ?>" @submit.prevent="onSubmit">
        <div class="account-table-content mb-2">
            ...
            <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                <label for="address_0" class="mandatory"><?php echo e(__('shop::app.customer.account.address.edit.street-address')); ?></label>
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/customers/account/address/edit.blade.php ENDPATH**/ ?>