...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="rental-slots-template">
        <div class="book-slots">
            <h3><?php echo e(__('bookingproduct::app.shop.products.rent-an-item')); ?></h3>

            <div v-if="renting_type == 'daily_hourly'">
                <div class="form-group">
                    <label class="label-style required"><?php echo e(__('bookingproduct::app.shop.products.choose-rent-option')); ?></label>
                    ...
                    <span class="radio">
                        ...
                        <?php echo e(__('bookingproduct::app.shop.products.daily-basis')); ?>
                    ...
                    <span class="radio">
                        ...
                        <?php echo e(__('bookingproduct::app.shop.products.hourly-basis')); ?>
            ...
            <div v-if="renting_type != 'daily' && sub_renting_type == 'hourly'">
                ...
                <div>
                    <label class="label-style required"><?php echo e(__('bookingproduct::app.shop.products.select-slot')); ?></label>

                    <div class="control-group-container">
                        <div class="form-group date" :class="[errors.has('booking[date]') ? 'has-error' : '']">
                            <date @onChange="dateSelected($event)">
                                <input type="text" v-validate="'required'" name="booking[date]" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.date')); ?>&quot;" placeholder="<?php echo e(__('bookingproduct::app.shop.products.select-date')); ?>" data-min-date="today"/>
                            </date>
                        ...
                        <div class="form-group slots" :class="[errors.has('booking[slot]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot]" v-model="selected_slot" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.slot')); ?>&quot;">
                                <option value=""><?php echo e(__('bookingproduct::app.shop.products.select-time-slot')); ?></option>
                ...
                <div v-if="slots[selected_slot] && slots[selected_slot]['slots'].length">
                    <label class="label-style required"><?php echo e(__('bookingproduct::app.shop.products.select-rent-time')); ?></label>

                    <div class="control-group-container">
                        <div class="form-group slots" :class="[errors.has('booking[slot][from]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot][from]" v-model="slot_from" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.slot')); ?>&quot;">
                                <option value=""><?php echo e(__('bookingproduct::app.shop.products.select-time-slot')); ?></option>
                        ...
                        <div class="form-group slots" :class="[errors.has('booking[slot][to]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot][to]" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.slot')); ?>&quot;">
                                <option value=""><?php echo e(__('bookingproduct::app.shop.products.select-time-slot')); ?></option>
            ...
            <div v-else>
                <label class="label-style required"><?php echo e(__('bookingproduct::app.shop.products.select-date')); ?></label>

                <div class="control-group-container">
                    <div class="form-group date" :class="[errors.has('booking[date_from]') ? 'has-error' : '']">
                        <date @onChange="dateSelected($event)">
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd|before_or_equal:date_to'" name="booking[date_from]" v-model="date_from" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.from')); ?>&quot;" placeholder="<?php echo e(__('bookingproduct::app.shop.products.from')); ?>" ref="date_from" data-min-date="today"/>
                        </date>
                    ...
                    <div class="form-group date" :class="[errors.has('booking[date_to]') ? 'has-error' : '']">
                        <date @onChange="dateSelected($event)">
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd|after_or_equal:date_from'" name="booking[date_to]" v-model="date_to" class="form-style" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.shop.products.to')); ?>&quot;" placeholder="<?php echo e(__('bookingproduct::app.shop.products.to')); ?>" ref="date_to" data-min-date="today"/>
                        </date>
        ...
        Vue.component('rental-slots', {
            ...
            methods: {
                dateSelected: function(date) {
                    ...
                    this.$http.get("<?php echo e(route('booking_product.slots.index', $bookingProduct->id)); ?>", {params: {date: date}})
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/BookingProduct/src/Resources/views/shop/velocity/products/view/booking/rental.blade.php ENDPATH**/ ?>