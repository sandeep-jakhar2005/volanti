...
<meta name="description" content="Order #<?php echo e($order->increment_id); ?> | Volanti Jet Catering" />
    ...
    <div class="sale-container mt10">
        ...
        <div class="section-content">
            ...
            <div class="payment_button pt-3">
                <form action="<?php echo e(route('order-invoice-view-detail', ['orderid'=> $order->id, 'customerid'=> $order->customer_id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="email" value="<?php echo e($order->customer_email); ?>">
                    <input type="hidden" name="tail_number" value="<?php echo e($order->fbo_tail_number); ?>">
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/resources/themes/volantijetcatering/views/customers/account/orders/view.blade.php ENDPATH**/ ?>