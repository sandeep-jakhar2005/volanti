...
<div class="form-group">
    <label class="label-style required"><?php echo e(__('bookingproduct::app.shop.products.special-notes')); ?></label>
    <textarea name="booking[note]" class="form-style" style="width: 100%"/>
</div><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/BookingProduct/src/Resources/views/shop/velocity/products/view/booking/table.blade.php ENDPATH**/ ?>