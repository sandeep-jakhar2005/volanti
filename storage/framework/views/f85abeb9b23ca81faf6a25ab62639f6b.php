    ...
    <tr>
        ...
        <td>
            <div class="control-group date" :class="[errors.has(controlName + '[to]') ? 'has-error' : '']">
                ...
                <time-component>
                    <input type="text" v-validate="{required: true, time_min: slotItem.from }" :name="controlName + '[to]'" v-model="slotItem.to" class="control" data-vv-as="&quot;<?php echo e(__('bookingproduct::app.admin.catalog.products.to')); ?>&quot;">
                </time-component>
...
<script>
    ...
    const time_validator = {
        getMessage: (field) => {
            return "<?php echo e(__('bookingproduct::app.admin.catalog.products.time-error')); ?>"
        },
...
</script><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/BookingProduct/src/Resources/views/admin/catalog/products/accordians/booking/slots.blade.php ENDPATH**/ ?>