            ...
            <?php echo view_render_event('bagisto.admin.customer.edit.before', ['customer' => $customer]); ?>
                ...
                <tab name="Carts" :selected="false">
                    ...
                    <?php echo view_render_event('bagisto.admin.customer.orders.list.before'); ?>
                        ...
                        <datagrid-plus src="<?php echo e(route('admin.customer.carts.data', $customer->id)); ?>"></datagrid-plus>
...
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Providers/../Resources/views/customers/edit.blade.php ENDPATH**/ ?>