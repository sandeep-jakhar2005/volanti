            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control usa_mobile_number" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" v-validate="'required|min:14'"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Providers/../Resources/views/customers/create.blade.php ENDPATH**/ ?>