<?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.before', ['product' => $product]); ?>


<accordian title="<?php echo e(__('admin::app.catalog.products.downloadable')); ?>" :active="true">
    <div slot="body">
        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.links.controls.before', ['product' => $product]); ?>


        <div id="downloadable-link-list-section" class="section">
            <div class="secton-title">
                <span><?php echo e(__('admin::app.catalog.products.links')); ?></span>
            </div>
        ...
        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.links.controls.after', ['product' => $product]); ?>


        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.samples.controls.before', ['product' => $product]); ?>


        <div id="downloadable-sample-list-section" class="section">
            <div class="secton-title">
                <span><?php echo e(__('admin::app.catalog.products.samples')); ?></span>
            </div>
        ...
        <?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.samples.controls.after', ['product' => $product]); ?>

    </div>
</accordian>

<?php echo view_render_event('bagisto.admin.catalog.product.edit_form_accordian.downloadable.after', ['product' => $product]); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="downloadable-link-list-template">
        <div class="table" style="overflow-x: auto;">
            <table style="margin-bottom: 20px;">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('admin::app.catalog.products.file')); ?></th>
                        <th><?php echo e(__('admin::app.catalog.products.sample')); ?></th>
                        <th><?php echo e(__('admin::app.catalog.products.downloads')); ?></th>
                        <th><?php echo e(__('admin::app.catalog.products.sort-order')); ?></th>
                        <th class="actions"></th>
                    </tr>
                </thead>
            ...
            <button type="button" class="btn btn-md btn-primary" @click="addLink">
                <?php echo e(__('admin::app.catalog.products.add-link-btn-title')); ?>
        ...
        <tr>
            <td>
                <div class="control-group" :class="[errors.has(linkInputTitleName) ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" v-model="link.title" :name="[linkInputTitleName]" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.name')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[price]') ? 'has-error' : '']">
                    <input type="text" v-validate="'min_value:0'" v-model="link.price" :name="[linkInputName + '[price]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.price')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" style="margin-bottom: 10px;">
                    <select v-model="link.type" :name="[linkInputName + '[type]']" class="control">
                        <option value=""></option>
                        <option value="file"><?php echo e(__('admin::app.catalog.products.upload-file')); ?></option>
                        <option value="url"><?php echo e(__('admin::app.catalog.products.url')); ?></option>
                    </select>
                </div>

                <div class="control-group" :class="[errors.has(linkInputName + '[file]') ? 'has-error' : '']" v-if="link.type == 'file'">
                    <input type="hidden" v-validate="'required'" :name="[linkInputName + '[file]']" v-model="link.file" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.file')); ?>&quot;"/>
                    ...
                    <label class="btn btn-black btn-md" :for="[linkInputName + '[file]']" style="width: auto; text-align: center;">
                        <?php echo e(__('admin::app.catalog.products.browse-file')); ?>
                ...
                <div class="control-group" :class="[errors.has(linkInputName + '[url]') ? 'has-error' : '']" v-if="link.type == 'url'">
                    <input type="text" v-validate="'required'" v-model="link.url" :name="[linkInputName + '[url]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.url')); ?>&quot;"/>
            ...
            <td>
                ...
                <div class="control-group" v-if="link.sample_type == 'file'">
                    <input type="hidden" :name="[linkInputName + '[sample_file]']" v-model="link.sample_file" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sampe-file')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[downloads]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required|numeric|min_value:0'" v-model="link.downloads" :name="[linkInputName + '[downloads]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.downloads')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required|numeric|min_value:0'" v-model="link.sort_order" :name="[linkInputName + '[sort_order]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sort-order')); ?>&quot;"/>
    ...
    <script type="text/x-template" id="downloadable-sample-list-template">
        <div class="table" style="overflow-x: auto;">
            ...
            <button type="button" class="btn btn-md btn-primary" @click="addSample">
                <?php echo e(__('admin::app.catalog.products.add-sample-btn-title')); ?>
        ...
        <tr>
            <td>
                <div class="control-group" :class="[errors.has(sampleInputTitleName) ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" v-model="sample.title" :name="[sampleInputTitleName]" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.name')); ?>&quot;"/>
            ...
            <td>
                ...
                <div class="control-group" :class="[errors.has(sampleInputName + '[file]') ? 'has-error' : '']" v-if="sample.type == 'file'">
                    <input type="hidden" v-validate="'required'" :name="[sampleInputName + '[file]']" v-model="sample.file" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.file')); ?>&quot;"/>
                ...
                <div class="control-group" :class="[errors.has(sampleInputName + '[url]') ? 'has-error' : '']" v-if="sample.type == 'url'">
                    <input type="text" v-validate="'required'" v-model="sample.url" :name="[sampleInputName + '[url]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.url')); ?>&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(sampleInputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required|numeric|min_value:0'" v-model="sample.sort_order" :name="[sampleInputName + '[sort_order]']" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.sort-order')); ?>&quot;"/>
    ...
    <script>
        let downloadableLinks = <?php echo json_encode($product->downloadable_links, 15, 512) ?>;
        let downloadableSamples = <?php echo json_encode($product->downloadable_samples, 15, 512) ?>;
        ...
        Vue.component('downloadable-link-list', {
            ...
            data: function() {
                return {
                    ...
                    old_links: <?php echo json_encode(old('downloadable_links'), 15, 512) ?>
                }
            },
            ...
            created: function() {
                ...
                for (let key in this.old_links) {
                    ...
                    if (key.indexOf('link_') !== -1) {
                        link['title'] = link["<?php echo e($locale); ?>"]['title'];

                        downloadableLinks.push(link);
                    } else {
                        for (let code in link) {
                            if (code === "<?php echo e($locale); ?>") {
        ...
        Vue.component('downloadable-link-item', {
            ...
            computed: {
                linkInputTitleName: function () {
                    if (this.link.id)
                        return "downloadable_links[" + this.link.id + "]" + '[<?php echo e($locale); ?>][title]';

                    return "downloadable_links[link_" + this.index + "]" + '[<?php echo e($locale); ?>][title]';
                },
            ...
            methods: {
                ...
                uploadFile: function(type) {
                    ...
                    this.$http.post("<?php echo e(route('admin.catalog.products.upload_link', $product->id)); ?>", formData, { headers: { 'Content-Type': 'multipart/form-data' } })
        ...
        Vue.component('downloadable-sample-list', {
            ...
            data: function() {
                return {
                    ...
                    old_samples: <?php echo json_encode(old('downloadable_samples'), 15, 512) ?>
                }
            },
            ...
            created: function() {
                ...
                for (let key in this.old_samples) {
                    ...
                    if (key.indexOf('sample_') !== -1) {
                        sample['title'] = sample["<?php echo e($locale); ?>"]['title'];
        ...
        Vue.component('downloadable-sample-item', {
            ...
            computed: {
                sampleInputTitleName: function () {
                    if (this.sample.id)
                        return "downloadable_samples[" + this.sample.id + "]" + '[<?php echo e($locale); ?>][title]';

                    return "downloadable_samples[sample_" + this.index + "]" + '[<?php echo e($locale); ?>][title]';
                },
            ...
            methods: {
                ...
                uploadFile: function(type) {
                    ...
                    this.$http.post("<?php echo e(route('admin.catalog.products.upload_sample', $product->id)); ?>", formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                        .then(function(response) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/catalog/products/accordians/downloadable.blade.php ENDPATH**/ ?>