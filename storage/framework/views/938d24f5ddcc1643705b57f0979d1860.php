<?php if(Webkul\Product\Helpers\ProductType::hasVariants($product->type)): ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            (() => {
                let galleryImages = <?php echo json_encode($galleryImages, 15, 512) ?>;
                ...
                Vue.component('product-options', {
                    ...
                    data: function() {
                        return {
                            defaultVariant: <?php echo json_encode($defaultVariant, 15, 512) ?>,
                    ...
                    methods: {
                        init: function () {
                            let config = <?php echo json_encode($config, 15, 512) ?>;
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Velocity/src/Resources/views/shop/products/view/configurable-options.blade.php ENDPATH**/ ?>