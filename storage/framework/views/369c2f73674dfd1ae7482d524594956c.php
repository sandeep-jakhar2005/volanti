        ...
        <div class="wrapper" style="display: flex; height: 60vh; width: 100%;
            ...
            <div class="error-box"  style="width: 50%">
                ...
                <div class="error-title" style="font-size: 100px;color: #5E5E5E">
                    <?php echo e(__('admin::app.error.in-maintenance')); ?>

                </div>

                <div class="error-messgae" style="font-size: 24px;color: #5E5E5E">
                    <?php echo e(core()->getCurrentChannel()->maintenance_mode_text ?: __('admin::app.error.right-back')); ?>
...
</html><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/errors/503.blade.php ENDPATH**/ ?>