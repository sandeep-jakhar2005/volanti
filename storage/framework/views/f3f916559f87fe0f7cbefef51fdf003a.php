...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="variant-form-template">
        <form
            method="POST"
            action="<?php echo e(route('admin.catalog.products.store')); ?>"
    ...
    <script type="text/x-template" id="variant-list-template">
        <div class="table" style="margin-top: 20px; overflow-x: auto;">
            <table>
                <thead>
                    <tr>
                        <th class="is-default"><?php echo e(__('admin::app.catalog.products.is-default')); ?></th>
                        <th class="sku"><?php echo e(__('admin::app.catalog.products.sku')); ?></th>
                        <th><?php echo e(__('admin::app.catalog.products.name')); ?></th>
                        <th><?php echo e(__('admin::app.catalog.products.images')); ?></th>
    ...
    <script type="text/x-template" id="variant-item-template">
        <tr>
                ...
                <div class="control-group">
                    <select
                        ...
                        <option
                            ...
                            <?php echo e(__('admin::app.catalog.products.enabled')); ?>
                        ...
                        <option
                            value="0"
                            :selected="!variant.status">
                            <?php echo e(__('admin::app.catalog.products.disabled')); ?>
            ...
            <td class="actions">
                <a :href="['<?php echo e(route('admin.catalog.products.index')); ?>/edit/' + variant.id]">
    ...
    <script>
        ...
        let variants = <?php echo json_encode($product->variants, 15, 512) ?>;
        ...
        Vue.component('variant-form', {
            ...
            methods: {
                ...
                getSuperAttributes: function() {
                    this.$http.get ("<?php echo e(route('admin.catalog.product.super-attributes', $product->id)); ?>")
                        .then ((response) => {
        ...
        Vue.component('variant-list', {
            ...
            data: function () {
                return {
                    variants: variants,
                    oldVariants: <?php echo json_encode(old('variants'), 15, 512) ?>,
                    superAttributes: {}
                }
            },
        ...
        Vue.component('variant-item', {
            ...
            data: function () {
                return {
                    defaultVariantId: parseInt('<?php echo e($product->additional['default_variant_id'] ?? null); ?>'),
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Admin/src/Resources/views/catalog/products/accordians/variations.blade.php ENDPATH**/ ?>