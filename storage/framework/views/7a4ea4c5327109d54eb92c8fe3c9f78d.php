    ...
    <div style="padding: 30px;">
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            ...
            <?php if($refund->tax_amount > 0): ?>
                <?php $__currentLoopData = Webkul\Tax\Helpers\Tax::getTaxRatesWithAmount($refund, false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxRate => $taxAmount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
...
<?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/emails/sales/new-refund.blade.php ENDPATH**/ ?>