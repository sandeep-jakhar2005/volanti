...
<?php $__env->startSection('account-content'); ?>
    <div class="account-layout">
        ...
        <div class="account-head">
            <span class="back-icon"><a href="<?php echo e(route('shop.customer.orders.index')); ?>"><i class="icon icon-menu-back"></i></a></span>
            ...
            <?php if($order->canCancel()): ?>
                ...
                <a href="javascript:void(0);" class="btn btn-lg btn-primary" onclick="cancelOrder('<?php echo e(__('shop::app.customer.account.order.view.cancel-confirm-msg')); ?>')" style="float: right;">
                        ...
                        <?php $__currentLoopData = $order->invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="sale-section">
                                <div class="secton-title">
                                    ...
                                    <a href="<?php echo e(route('shop.customer.orders.print', $invoice->id)); ?>" class="pull-right">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/volantiScottsdale/packages/Webkul/Shop/src/Resources/views/customers/account/orders/view.blade.php ENDPATH**/ ?>